...
#Adapted from https://github.com/victorhcm/dockerfiles/blob/master/opencv/Dockerfile
...
RUN \ 
    ...
    # add support for VTK and python-tk
    apt-get install libvtk5-dev python-tk -y && \
